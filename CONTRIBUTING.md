...
Anyone can submit an issue to <https://github.com/wlandau/targets-minimal/issues> or comment on an existing thread. Common reasons are to
...
1. Prior to contribution, please propose your idea in a [new issue thread](https://github.com/wlandau/targets-minimal/issues) so you and the maintainer can define the intent and scope of your work.
