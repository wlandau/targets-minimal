...
To enable continuous deployment in your own project, simply commit the [`.github/workflows/targets.yaml`](https://github.com/wlandau/targets-minimal/blob/main/.github/workflows/targets.yaml) workflow file to your GitHub repository and ensure Actions are enabled. Keep in mind that GitHub has strict storage limitations, so this pattern is only appropriate for small [`targets`](https://docs.ropensci.org/targets) pipelines. 
